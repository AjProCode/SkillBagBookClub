...
export default function ReviewsPage() {
  ...
  const { data: reviews, isLoading: loadingReviews } = useQuery<BookReview[]>({
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section id="reviews" className="py-12 bg-light flex-grow">
        <div className="container mx-auto px-4">
          <h2 className="font-heading font-bold text-2xl md:text-3xl mb-8">Book Reviews By Kids Like You</h2>
